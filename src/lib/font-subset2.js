...
const SOURCE_DIRS = [
  path.resolve(ROOT, "_companies"),
  path.resolve(ROOT, "_relatives"),
  path.resolve(ROOT, "src/app/all"),
...
const FONT_OUTPUT = "src/app/ZCOOLKuaiLe-Subset2.woff2";
const UNICODE_FILE = "src/lib/unicodes2.txt";
