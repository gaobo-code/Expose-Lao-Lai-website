...
export default function ActiveChart() {
    return (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 b:gap-6 lg:gap-8 xl:gap-12 w-full b:px-5 box-border">
            <div className="flex flex-col items-center justify-center py-[12px] lg:py-[16px] xl:py-[24px] box-border rounded-[12px] bg-[#f2f2f2] dark:bg-articlebackground shadow-sm hover:shadow-xl hover:scale-103 transition-all duration-600 ease-out dark:opacity-90">
