    ...
    <>
      <section className="w-full xl:w-320 flex flex-col items-center pt-15 pb-22 px-4 sm:px-8 box-border">
        ...
        <div className="w-full flex flex-col b:flex-row mb-13">
          ...
          <div className="b:flex-7 b:px-4 box-border tracking-widest">
            <div className="mb-5">
              <div className="text-[17px] font-bold text-secondmaincolor dark:text-maincolor mb-2">
                个人信息
              </div>
              <div className="text-[19px] leading-normal b:leading-[1.55] break-all justify-cjk">
                <span>姓名：</span>
            ...
            <div className="mb-5">
              ...
              <div className="text-[19px] leading-normal b:leading-[1.55] justify-cjk">
            ...
            <div className="">
              ...
              <div className="text-[0]  leading-normal b:leading-[1.55] justify-cjk">
                <span className="text-[19px]">
                  王思宇于2020年成立了辽宁志在远方网络科技有限公司，这是一家以软件开发和外包为服务的公司，员工人数最多时达到50人，然而
                </span>
                <span className="text-[19px]">
                  王思宇从一开始就没打算把这家公司经营好。对待员工，他使用暴力、罚款、骗术来管理，不尊重技术人员，奴隶化盛行，后期大肆欠薪，十分嚣张。
                </span>
                <span className="text-[19px]">
                  对待客户，他拿到项目定金之后，故意违背约定，按照简化版，或者直接按照错误的需求去做，做出来的东西对客户完全没用，这导致客户非常的不满。
                </span>
                <span className="text-[19px]">
                  这家公司实际运营2年多，不断的遭到员工和客户的起诉，2年之间吃了{guansi}个官司，名誉扫地。王思宇也在沈阳藏了起来，所有人都找不到他，
                </span>
                <span className="text-[19px]">
                ...
                <span className="text-[19px]">
                  该公司实际上就是辽宁志在远方网络科技有限公司的换壳公司，依然采用的是原先那些领导。目前，王思宇本人和他的团队活跃在qq群、百度贴吧，
                </span>
                <span className="text-[19px]">
                  以软件开发、出售服务的名义，毫无底线的骗钱，甚至连30多块钱都去骗，被众多网友辱骂和谴责。据我对他的了解，
                </span>
                <span className="text-[19px]">
      ...
      <div className="w-screen flex justify-center bg-secondbackground">
        <section className="w-full xl:w-320 flex flex-col items-center pt-15 pb-23 px-4 sm:px-8 box-border">
          ...
          <div className="w-full b:px-5 box-border mb-13 leading-normal b:leading-[1.55] tracking-widest text-[0] justify-cjk">
            <span className="text-[19px]">
              下面的图片作为证据，它们的来源分别是&nbsp;
            </span>
            <a
