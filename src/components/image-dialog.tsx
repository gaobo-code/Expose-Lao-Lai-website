...
export function ImageDialogContent({
  ...
  return (
    <div className="relative">
      <DialogPanel className="h-200 2xl:h-214 3xl:h-227 max-h-[98vh] aspect-6/5 border bg-white box-border overflow-hidden shadow-lg">
        <AnimatePresence initial={false}>
          ...
          >
            ...
            <div className="w-full h-[calc(100%-var(--spacing)*50)] py-6 px-6 box-border">
            ...
            <Description className="w-full h-30 px-8 box-border text-lg leading-[1.55] tracking-widest font-bold overflow-hidden text-secondmaincolor">
